...
const Academy: React.FC = () => {
  const [toggleAcademy, setToggleAcademy] = useState(false)
  ...
  const fetchAcademy = useCallback(async () => {
    if (!user) return
    setLoading(true)
    const { data: res, error, message } = await getAcademy(user?.personId)
